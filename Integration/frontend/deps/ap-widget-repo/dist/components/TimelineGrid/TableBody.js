...
function getStyles(props) {
  return {
    ...
    rowColumn: {
      ...
      marginLeft: 10,
      fontSize: 14,
      color: _colors.darkBlack, // fade(muiTheme.palette.textColor, 0.54),
      overflow: 'hidden',
...
/**
 * Provides timeline grid table body.
 *
 * @private
 */
...
var TableBody = exports.TableBody = function (_React$Component) {
  ...
  function TableBody(props, context) {
    ...
    _this._toggleTimeSort = _this._toggleTimeSort.bind(_this);
    return _this;
  }
  ...
  (0, _createClass3.default)(TableBody, [{
    ...
    key: '_toggleTimeSort',
    value: function _toggleTimeSort(toggleState) {
      var _props = this.props,
          group = _props.group,
          requestPackage = _props.requestPackage;


      requestPackage(group, { desc: toggleState, action: 'refresh' });
    }
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          group = _props2.group,
          measurementSystem = _props2.measurementSystem;


      var sortDesc = true;
      if (timelineData) {
        sortDesc = timelineData.params.desc;
      }
      ...
      return (0, _jsx3.default)('div', {
        ...
        group: group,
        timeSortDesc: sortDesc,
        onToggleTimeSort: this._toggleTimeSort,
        columns: columns,
...
exports.default = (0, _SICKPlatform.connect)(mapStateToProps, _timelineData.actions)(TableBody);