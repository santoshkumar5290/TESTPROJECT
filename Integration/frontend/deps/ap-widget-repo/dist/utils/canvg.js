...
var _stackblur = require('stackblur');
...
function build(opts) {
	...
	svg.Property.prototype.addOpacity = function (opacityProp) {
		...
		if (opacityProp.value != null && opacityProp.value != '' && typeof this.value == 'string') {
			...
			var color = new _rgbcolor2.default(this.value);
			if (color.ok) {
	...
	svg.Element.animateColor = function (node) {
		...
		this.calcValue = function () {
			var p = this.progress();
			var from = new _rgbcolor2.default(p.from.value);
			var to = new _rgbcolor2.default(p.to.value);
	...
	svg.Element.feGaussianBlur = function (node) {
		...
		this.apply = function (ctx, x, y, width, height) {
			if (typeof _stackblur2.default.canvasRGBA == 'undefined') {
			...
			_stackblur2.default.canvasRGBA(ctx.canvas.id, x, y, width, height, this.blurRadius);
