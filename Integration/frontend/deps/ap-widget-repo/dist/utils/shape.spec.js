...
describe('(Utility -> Method) Shape -> getBoundingBoxDimensions', function () {
  it('Should calculate 45 degrees correctly.', function () {
    var dimensions = (0, _shape.getBoundingBoxDimensions)(1, 1, 45);
  ...
  it('Should calculate 0 degrees correctly.', function () {
    var dimensions = (0, _shape.getBoundingBoxDimensions)(1, 1, 0);
  ...
  it('Should calculate 0 length correctly.', function () {
    var dimensions = (0, _shape.getBoundingBoxDimensions)(0, 0, 0);
